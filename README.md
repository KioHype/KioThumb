...
Eu tenho um canal de longplay no YouTube e toda vez que ia postar uma série nova, precisava abrir o Photoshop (ou similar), criar a thumbnail, salvar, mudar o número, salvar de novo... para cada episódio. Uma encheção de saco.
...
Feito por **[seu nome ou nome do canal aqui]**  
Canal: [link do seu canal]
